...
public class Program{
    public static void main(String[] args) {
        ...
        Zoo zoo = new Zoo();
        zoo.addAnimalDirect(new Aist(50.0, 10.5, "blue", 1500.0));
        zoo.addAnimalDirect(new Cat(10.0, 5.0, "green", "Flufy", "regular Cat", true,
                "black", "03.05.2010", true));
        zoo.addAnimalDirect(new Chicken(10.5, 5.5, "braun", 0.0));
        zoo.addAnimalDirect(new Dog(20.0, 30.8, "blue", "Rex", "Dog", true,
                "white", "01.01.2015", true));
        zoo.addAnimalDirect(new Tiger(80.5, 100.2, "blue-green", "Jungle", "06.08.2003"));
        zoo.addAnimalDirect(new Wolf(20.5, 20.8, "dark", "Forest", "01.01.2005",
                false));
        ...
        while (true) {
            ...
            System.out.println("7. Поcмотреть на наших птиц");
            System.out.println("8. Поcмотреть на ласковых животных");
